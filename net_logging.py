...
class DatabaseLog(Base):
    ...
    id: Mapped[int] = mapped_column(primary_key=True)  # [id] [bigint] IDENTITY(1,1) NOT NULL,
    log_level: Mapped[int] = mapped_column()  # [log_level] [int] NULL,
    log_levelname: Mapped[str] = mapped_column(String(32))  # [log_levelname] [char](32) NULL,
    log: Mapped[str] = mapped_column(String)  # [log] [char](2048) NOT NULL,
    created_at: Mapped[datetime] = mapped_column(DateTime)  # [created_at] [datetime2](7) NOT NULL,
    created_by: Mapped[str] = mapped_column(String(1024))  # [created_by] [char](32) NOT NULL,
